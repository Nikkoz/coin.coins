...
func (_m *Storage) CountUrls(ctx context.Context, coinId uint) (uint64, error) {
...
func (_m *Storage) CreateUrl(ctx context.Context, _a1 *url.Url) (*url.Url, error) {
...
func (_m *Storage) DeleteUrl(ctx context.Context, ID uint) error {
...
func (_m *Storage) ListUrls(ctx context.Context, coinId uint, parameter queryParameter.QueryParameter) ([]*url.Url, error) {
...
func (_m *Storage) UpdateUrl(ctx context.Context, _a1 *url.Url) (*url.Url, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *Storage) UpsertUrls(ctx context.Context, urls ...*url.Url) ([]*url.Url, error) {
...
func (_m *Storage) UrlById(ctx context.Context, ID uint) (*url.Url, error) {
	ret := _m.Called(ctx, ID)
