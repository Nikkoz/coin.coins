...
func (_m *Url) ById(ctx context.Context, ID uint) (*url.Url, error) {
...
// Count provides a mock function with given fields: ctx, coinId
func (_m *Url) Count(ctx context.Context, coinId uint) (uint64, error) {
...
func (_m *Url) Create(ctx context.Context, _a1 *url.Url) (*url.Url, error) {
...
// Delete provides a mock function with given fields: ctx, ID, coinId
func (_m *Url) Delete(ctx context.Context, ID uint, coinId uint) error {
	ret := _m.Called(ctx, ID, coinId)
...
// List provides a mock function with given fields: ctx, coinId, parameter
func (_m *Url) List(ctx context.Context, coinId uint, parameter queryParameter.QueryParameter) ([]*url.Url, error) {
...
func (_m *Url) Update(ctx context.Context, _a1 *url.Url) (*url.Url, error) {
	ret := _m.Called(ctx, _a1)
...
// Upsert provides a mock function with given fields: ctx, urls
func (_m *Url) Upsert(ctx context.Context, urls ...*url.Url) ([]*url.Url, error) {
