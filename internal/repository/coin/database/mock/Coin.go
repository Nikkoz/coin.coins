...
func (_m *Coin) CreateCoin(ctx context.Context, _a1 *coin.Coin) (*coin.Coin, error) {
...
func (_m *Coin) DeleteCoin(ctx context.Context, ID uint) error {
	ret := _m.Called(ctx, ID)
...
func (_m *Coin) ListCoins(ctx context.Context, parameter queryParameter.QueryParameter) ([]*coin.Coin, error) {
...
func (_m *Coin) UpdateCoin(ctx context.Context, _a1 *coin.Coin) (*coin.Coin, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *Coin) UpsertCoins(ctx context.Context, coins ...*coin.Coin) ([]*coin.Coin, error) {
